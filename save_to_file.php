...
//переводим массив в JSON и очищаем JSON-строку от лишнего хлама согласно условия задания
$str = str_replace('","', '', json_encode($reversed));
$str = str_replace('["', '', $str);
$str = str_replace('"]', '', $str) . "\r\n";
//выводим строку в файл .txt
file_put_contents('my_json.txt', $str, FILE_APPEND);
